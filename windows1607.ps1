...
# Unistall Apps
$winApps = @("Microsoft.3DBuilder","Microsoft.Appconnector","Microsoft.BingFinance"
"Microsoft.BingNews","Microsoft.BingSports","Microsoft.BingWeather","Microsoft.Getstarted","Microsoft.MicrosoftOfficeHub"
"Microsoft.MicrosoftSolitaireCollection","Microsoft.OneConnect","Microsoft.People","Microsoft.SkypeApp","Microsoft.WindowsAlarms"
"Microsoft.WindowsMaps","Microsoft.WindowsPhone","Microsoft.WindowsSoundRecorder","Microsoft.XboxApp","Microsoft.ZuneMusic"
"Microsoft.ZuneVideo","microsoft.windowscommunicationsapps","Microsoft.MinecraftUWP","Microsoft.MicrosoftPowerBIForWindows","Microsoft.NetworkSpeedTest","Microsoft.CommsPhone"
"Microsoft.ConnectivityStore","Microsoft.Messaging","Microsoft.Office.Sway","Microsoft.OneConnect","Microsoft.WindowsFeedbackHub"
"Microsoft.BingFoodAndDrink","Microsoft.BingTravel","Microsoft.BingHealthAndFitness","Microsoft.WindowsReadingList")

foreach ($w in $winApps) {
    Get-AppxPackage $w -AllUsers | Remove-AppxPackage
    Get-AppxProvisionedPackage -Online | Where DisplayName -EQ $w | Remove-AppxProvisionedPackage -Online
...
foreach ($uninstall in $uninstallAppsIP) {Set-ItemProperty -Path $uninstall[0] -Name $uninstall[1] -Value $uninstall[2]}
...
"HKLM:\SYSTEM\CurrentControlSet\Services\lfsvc\Service","HKCU:\SOFTWARE\Microsoft\Siuf\Rules",
...
"HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors","HKLM:\SOFTWARE\Policies\Microsoft\Windows\Maps",
"HKCU:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors","HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer",
"HKLM:\SOFTWARE\Policies\Microsoft\PCHealth\HelpSvc","HKLM:\SOFTWARE\Policies\Microsoft\PCHealth\ErrorReporting",
...
$userSettingsIP = @("HKCU:\Control Panel\International\User Profile","HttpAcceptLanguageOptOut",1),
...
@("HKLM:\SYSTEM\CurrentControlSet\Services\lfsvc\Service","Configuration",0),
...
@("HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer","NoUseStoreOpenWith",1),
@("HKLM:\SOFTWARE\Policies\Microsoft\PCHealth\HelpSvc","Headlines",1),
...
@("HKLM:\SOFTWARE\Policies\Microsoft\Messenger\Client","CEIP",1),
@("HKLM:\SOFTWARE\Policies\SQMClient\Windows","CEIPEnable",1),
@("HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System","LocalAccountTokenFilterPolicy",1),
@("HKLM:\SOFTWARE\Policies\Microsoft\WindowsUpdate","DisableDualScan",1)
...
Make-HiveKey ("HKLM:\SOFTWARE\Microsoft\WcmSvc\wifinetworkmanager\features" + $sid)
Set-ItemProperty -Path ("HKLM:\SOFTWARE\Microsoft\WcmSvc\wifinetworkmanager\features" + $sid) -Name "FeatureStates" -Value 0x33c
$wifiFeaturesIP = @("WiFiSenseCredShared",0),@("WiFiSenseOpen",0)
foreach ($wifi in $wifiFeaturesIP) {Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\WcmSvc\wifinetworkmanager\features" -Name $wifi[0] -Value $wifi[1]}
...
if (Get-Service -Name "dmwappushservice") {
...
$netSettingsHK = @("HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\Main","HKCU:\SOFTWARE\Policies\Microsoft\Internet Explorer\Main",
"HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\BrowserEmulation","HKCU:\SOFTWARE\Policies\Microsoft\Internet Explorer\BrowserEmulation",
"HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\CommandBar","HKCU:\SOFTWARE\Policies\Microsoft\Internet Explorer\CommandBar",
"HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\Browser Emulation","HKCU:\SOFTWARE\Policies\Microsoft\Internet Explorer\Browser Emulation",
"HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent")

$netSettingsIP = @("HKCU:\SOFTWARE\Microsoft\Internet Explorer\Main","Start Page",$homePage),
@("HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings","ProxyServer",$proxyInfo),
...
$cortanaIP = @("HKLM:\SOFTWARE\Microsoft\Windows Search","AllowCortana",0),
...
# Remove Services
$services = @('XboxNetApiSvc','XblGameSave','XblAuthManager','OneSyncSvc_47eef7','Mapsbroker',
'WalletService','WinDefend','WMPNetworkSvc','lfsvc','HomeGroupProvider','HomeGroupListener','DiagTrack')
...
slmgr //B /ipk W269N-WFGWX-YVC9B-4J6C9-T83GX -Quiet
slmgr //B /skms $activationServer
slmgr //B /ato
...
# Capture Image
# net use z: $destinationForWim /user:$userInfo
# D:
# dism /Capture-Image /ImageFile:z:\install.wim /capturedir:d:\ /name:W10X64_1607
